    ...
    <div className="space-y-8">
        ...
        {bestExitBond && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Bono con mayor rendimiento anualizado simulando salida temprana
                por compresión de tasa.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2 text-sm">
              <p>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Rendimiento estimado de mantener bonos en ARS hasta el vencimiento y
            convertir a Dólar MEP.{" "}
            <span className="font-bold">
              MEP Actual: ${carryTradeData.mep?.toFixed(2)}
            </span>
            <p>
        ...
        <CardContent className="space-y-6">
          <CarryTable
            data={carryTradeData.carryData}
            mep={carryTradeData.mep}
          />
        </CardContent>
      </Card>
